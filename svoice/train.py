...
def run(args):
    ...
    train_loader = load_data(train_path="/ssd_scratch/cvit/aparna/preprocessed_lrs3", num_workers=hparams.hparams.num_workers, batch_size=hparams.hparams.batch_size, shuffle=True, split='train',num_spearkers=2)

    total_batch = len(train_loader)
    print("Total train batch: ", total_batch)

    test_loader = load_data( train_path="/ssd_scratch/cvit/aparna/preprocessed_lrs3", num_workers=hparams.hparams.num_workers, batch_size=hparams.hparams.batch_size, shuffle=False, split='val',num_spearkers=2)
    ...
    data = {
            ...
            "cv_loader": test_loader,
            "tt_loader": test_loader
    }
